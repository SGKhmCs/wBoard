...
export class WriterToolsComponent implements OnInit, OnDestroy {
    ...
    registerChangeInWriterTools() {
        this.eventSubscriber = this.eventManager.subscribe('writerToolsListModification', (response) => this.reset());
    }

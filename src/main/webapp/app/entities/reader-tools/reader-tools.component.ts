...
export class ReaderToolsComponent implements OnInit, OnDestroy {
    ...
    registerChangeInReaderTools() {
        this.eventSubscriber = this.eventManager.subscribe('readerToolsListModification', (response) => this.reset());
    }
